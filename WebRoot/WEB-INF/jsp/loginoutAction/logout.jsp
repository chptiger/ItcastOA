...
<head>
	...
	<title>Already Exists Itcast OA </title>
...
<body>
	<table border=0 cellspacing=0 cellpadding=0 width=100% height=100%>
		<tr>
			<td align=center>
				<div id=Logout>
					...
					<div id=LogoutOperate>
						...
						<%-- 这个超链接不适用<s:a>标签！！ --%>
						<a href="${pageContext.request.contextPath}/loginout_loginUI.do">re-enter Itcast OA</a>
			...
			FireFox不可以关闭
						-->
                    <img src="${pageContext.request.contextPath}/style/blue/images/logout/logout3.gif" border=0 /> <a href="javascript:window.open('', '_self'); window.close();">Close current window</a>
                    </div>
				</div>
			</td>
		</tr>
