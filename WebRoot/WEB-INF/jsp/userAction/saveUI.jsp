...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> User Info
        </div>
...
<div id=MainArea>
    ...
    <s:form action="user_%{id == null ? 'add' : 'edit'}">
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" /> User Info </div> 
        </div>
		...
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" /> Role Console </div> 
        </div>
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                        	...
                        	/>
                        	multiple choose or cancel with Ctrl Key
                        </td>
                    </tr>
                </table>
            </div>
