		...
		<div class="ForumPageTableBorder" style="margin-top: 25px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					...
					<td width="80" class="ForumPageTableTitle">Topic Number</td>
					<td width="80" class="ForumPageTableTitle">Sum Topic Number</td>
					<td width="270" class="ForumPageTableTitle">Latest Topic</td>
				</tr>
