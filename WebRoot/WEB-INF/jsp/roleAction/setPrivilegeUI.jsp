	...
	<script type="text/javascript">
		...
		// add onclick envent
			$("input[name=privilegeIds]").click(function(){
				// when choose or cancel one privilege, same effect for all children privileges
				$(this).siblings("ul").find("input").attr("checked", this.checked);
			// when choose one privilege, choose all direct parent privileges.
				if (this.checked == true) {
					$(this).parents("li").children("input[name=privilegeIds]").attr("checked", true);
				} 
				else {
			// when cancel one privilege, if all sibilings not chosed, cacel all direct parent privileges
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> Set Privilege
        </div>
					...
					<thead>
						<tr align="LEFT" valign="MIDDLE" id="TableTitle">
							<td width="300px" style="padding-left: 7px;">
								...
								<label for="cbSelectAll">All</label>
